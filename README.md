...
# CDKTN prebuilt bindings for hashicorp/cloudinit provider version 2.4.1

This repo builds and publishes the [Terraform cloudinit provider](https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform cloudinit provider](https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1)
