...
// https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/resources/config
...
export interface ConfigConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly part?: ConfigPart[] | cdktn.IResolvable;
}
...
export function configPartToTerraform(struct?: ConfigPart | cdktn.IResolvable): any {
...
export function configPartToHclTerraform(struct?: ConfigPart | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ConfigPartOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConfigPart | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ConfigPart | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class ConfigPartList extends cdktn.ComplexList {
  public internalValue? : ConfigPart[] | cdktn.IResolvable
...
export class Config extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Config that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/resources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/resources/config cloudinit_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putPart(value: ConfigPart[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      part: cdktn.listMapper(configPartToTerraform, true)(this._part.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      part: {
        value: cdktn.listMapperHcl(configPartToHclTerraform, true)(this._part.internalValue),
        isBlock: true,
        type: "list",
