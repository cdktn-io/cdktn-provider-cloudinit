...
// https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/data-sources/config
...
export class DataCloudinitConfig extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudinitConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/data-sources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/cloudinit/2.4.1/docs/data-sources/config cloudinit_config} Data Source
  *
  * @param scope The scope in which to define this construct
